...
Claude (claude.ai) was used as a learning and development aid throughout this project:
- To understand the conceptual difference between threads and processes (building on prior knowledge of `fork()` from pipex).
- To review and discuss mutex locking strategies and potential race conditions.
- To suggest and explain the asymmetric fork-picking approach for deadlock prevention.
